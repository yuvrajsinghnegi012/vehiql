            ...
            {carMakes.map((make => {
              return (
                <Link
                  ...
                  className="bg-white rounded-lg shadow p-4 ext-center hover:shadow-md transition cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Thousand of verified vechicles from trusted dealerships and private sellers.
              </p>
            </div>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who found their perfect vechicle through our platform.
          </p>
